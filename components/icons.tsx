...
/** Glyphe WhatsApp officiel (absent de lucide-react). */
...
/**
 * Marques sociales — `lucide-react` ne fournit plus d'icônes de marque depuis
 * la v1, et une police d'icônes entière pour trois glyphes serait absurde.
 * Tracés officiels, en `currentColor` comme le reste du jeu.
 */
function BrandIcon({
  path,
  className,
...
/** Icône d'un compte officiel — la clé est le `label` de `socialLinks`. */
export function SocialIcon({
  ...
  if (!path) return null;
  return <BrandIcon path={path} className={className} />;
}
